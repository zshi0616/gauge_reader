# -*- coding: utf-8 -*-
"""
Created on Mon Oct  7 11:18:45 2019
...
VIDEO_PATH = 'D:/C#_finial/water_gauge_pooling/西圩子濠-杆石桥_2019070611523024AFD6A0_1562385150_1 00_00_34-00_01_20.mp4'
FRAME_TOTAL = 500
FRAME_STEP = 20
...
my_kernel = np.array([[0, -1, -2], [1, 0, -1], [2, 1, 0]])
...
def edgeDetect(img, imgcolor):
    ...
    cv2.drawContours(imgcolor, contours, -1, (0, 255, 0), 2)
    imgOut(imgcolor, 'contours.jpg')
...
def gaugeRead(frame):
    ...
    #提取边沿
    binary, contours, hierarchy = cv2.findContours(img_bin, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
